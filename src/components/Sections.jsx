...
import { Brain, FileCode2, GitBranch, ShieldCheck, Workflow, Telescope, Users2, Building2, Sparkles, CheckCircle2, Bot } from 'lucide-react'
...
function FeatureCard({ Icon, title, desc }) {
  return (
    <motion.div
      ...
      className="rounded-xl bg-white p-5 ring-1 ring-black/10 shadow-sm hover:shadow-md transition-shadow"
    >
      ...
      <section id="recruiters" className="py-20 sm:py-24 bg-gradient-to-b from-fuchsia-50/50 to-transparent">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            ...
            >
              <div className="aspect-[4/3] rounded-lg bg-gradient-to-br from-fuchsia-600/10 to-blue-600/10 grid place-content-center text-center">
